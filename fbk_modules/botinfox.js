...
module.exports.run = async (bot, message, args) => {
	...
	var days = Math.floor(bot.uptime / 86400000000000)
		var hours = Math.floor((bot.uptime % 86400000000000) / 3600000)
		var minutes = Math.floor(((bot.uptime % 86400000000000) % 3600000) / 60000)
		var seconds = Math.floor((((bot.uptime % 86400000000000) % 360000) % 60000) / 1000)
		...
		.addField('Hosted by', '[FireTabbyNation](https://firetabbynation.com)', true)
